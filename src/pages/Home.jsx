...
const Home = () => {
  return (
    <div>
        ...
        <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent
            ...
            <Link to={"/signup"} >
                ...
                <div className="group mt-16 p-1 mx-auto rounded-full bg-richblack-800
                    ...
                    <div className='flex flex-row items-center gap-x-2 rounded-full
            ...
            <div className='mt-4 w-[90%] text-center text-lg fond-bold 
                          text-richblack-300'>
                ...
                presonalized feedback from instructors.
            </div>
        ...
        bg-richblack-900 text-white py-10'>
